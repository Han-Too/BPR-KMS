                    ...
                    <div class="row">
                        <div class="col">
                          <div class="logo d-flex justify-content-center mt-4">
                            <h5 class="fs-1 fw-bold">Data Kegiatan</h5>
                          </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                      @forelse ($datakegiatan as $item)
                        <tr>
                          ...
                          <td class="lh-sm col-3">{{ $item->tanggal }}</td>
                          <td class="lh-sm col-3">{{ $item->kode_kegiatan }}</td>
                          <td class="lh-sm col-3">{{ $item->deskripsi }}</td>
                          <td class="lh-sm col-3">{{ $item->kode_jabatan }}</td>
